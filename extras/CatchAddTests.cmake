...
function(catch_discover_tests_impl)
  ...
  cmake_parse_arguments(
    ...
    "TEST_EXTRA_ARGS;TEST_PROPERTIES;TEST_EXECUTOR;TEST_DL_PATHS;TEST_DL_FRAMEWORK_PATHS;ADD_TAGS_AS_LABELS;TEST_LIST_REPORTER"
    ${ARGN}
  )
  ...
  execute_process(
    COMMAND ${_TEST_EXECUTOR} "${_TEST_EXECUTABLE}" ${spec} --list-tests --reporter ${_TEST_LIST_REPORTER}
...
if(CMAKE_SCRIPT_MODE_FILE)
  catch_discover_tests_impl(
    ...
    TEST_LIST_REPORTER ${TEST_LIST_REPORTER}
  )
endif()
